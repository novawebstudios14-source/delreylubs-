-- Existing services require individual review before they are visible through a QR code.
alter table public.services add column is_public boolean not null default false;
...
returns jsonb language sql stable security definer set search_path = '' as $$
  select jsonb_build_object(
    ...
    'services', coalesce((
      ...
      where s.vehicle_id = v.id and s.is_public = true
    ), '[]'::jsonb)
  )
